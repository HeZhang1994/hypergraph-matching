...
% Parameter for Selecting SIFT Points.
distRatio = 0.55; % 0.55 - Total runtime = 2'50''.

% Parameters for Resizing Input Images.
imreszierate1 = 0.5;  
imreszierate2 = 0.4;  

% Parameters for Refining Correspondences.
...
% Transfer the image coordinate to the Cartesian coordinate.
...
% Remove the points with the same location - One-to-one matching task.
...
% Tranfer the solution to the image coordinate.
